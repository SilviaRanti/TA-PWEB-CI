  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('welcome'); ?>">
        ...
        <div class="sidebar-brand-text mx-3">Makanan Lampung</div>
      </a>
...
-->
  ...
  <div class="header-right">
    <a href="#home">Home</a>
    <a href="#contact">pie</a>
    <a href="#about">Bakso Kemasan</a>
    <a href="#about">Sambal</a>
    <a href="#about">Tanpa Kategori</a>
